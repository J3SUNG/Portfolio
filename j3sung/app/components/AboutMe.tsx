  ...
  return (
    ...
    >
      ...
      <div className="sm:flex">
        ...
        <div className="ml-[0px] sm:ml-16 mt-6 font-Binggrae">
          <h2 className="text-[40px] font-bold">고민하는 개발자, 이제성입니다.</h2>
          <ul className="mt-[10px] sm:mt-[20px] leading-5 sm:leading-[60px] text-[8px] sm:text-[22px]">
            <li>- 안녕하세요! 주니어 프론트엔드 개발자 이제성입니다.</li>
            <li>- Clean Code와 테스트, 성능 개선에 대한 고민을 생활화 합니다.</li>
            <li>- 꾸준하게 학습한 내용을 Github에 남기고, 기술 블로그를 운영합니다. </li>
